...
DEBUG = False
ALLOWED_HOSTS = ['.bookedfusion.com',
...
GOOGLE_OAUTH2_CLIENT_SECRETS_JSON = os.path.join(
    BASE_DIR, '.keys', 'client_secret.json')
GOOGLE_SERVICE_ACC_JSON = os.path.join(
    BASE_DIR, '.keys', 'BookingBF-serviceaccount.json')
...
# -------------- chargebee ---------------
#CHARGEBEE_API_KEY = 'test_xcdcuEEHi2lhIGQp2ebh1u5pIU60jzx5XA'
CHARGEBEE_API_KEY = 'live_86fz70toZK6Dcl4ieRSR26Cl7sGeVK5V'
# CHARGEBEE_WEBSITE = 'bookedfusion-test'
